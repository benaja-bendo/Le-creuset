import { Activity, Box, Clock, DollarSign, FileText, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-secondary-500">Bienvenue, voici un aperçu de vos projets en cours.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl border border-secondary-200 shadow-sm p-6">
          <h2 className="text-lg font-bold text-secondary-900 mb-6">Notifications</h2>
